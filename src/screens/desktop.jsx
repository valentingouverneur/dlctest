...
import { Packshot, SideItem, Pill, CopyField } from '../primitives';
import { Field, FieldChips } from './mobile-sheet';
...
export function CatalogueDesktop({ products, selectedId, onSelect, editing, onEdit, onCloseDetail, activeNav = 'catalogue', onNav, hideSidebar = false, density = 'standard', toFix = false }) {
  const [q, setQ] = useState('');
  const [cat, setCat] = useState('Tous');
  const [paste, setPaste] = useState('');
  const [showFix, setShowFix] = useState(toFix);
