...
import { Packshot, ProductRow } from '../primitives';

export function MobileBar({ title, onMenu, onScan, scanCount, leftAction, rightActions }) {
  return (
    <div style={{
      flex: '0 0 auto',
...
export function CatalogueMobile({ onOpenProduct, onScan, onMenu, scanCount = 12, products }) {
